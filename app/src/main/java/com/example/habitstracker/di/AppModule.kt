...
import com.example.habitstracker.profile.data.DefaultSyncRepository
import com.example.habitstracker.profile.data.local.LocalSyncRepository
import com.example.habitstracker.profile.data.local.AppPreferences
import com.example.habitstracker.profile.data.remote.CloudSyncRepository
import com.example.habitstracker.profile.data.remote.firebase.UserFirebaseDataSource
import com.example.habitstracker.profile.data.repository.FriendsRepositoryImpl
import com.example.habitstracker.profile.data.repository.UserProfileRepositoryImpl
import com.example.habitstracker.profile.data.repository.UserStatsRepositoryImpl
...
import com.example.habitstracker.profile.domain.repository.UserStatsRepository
import com.example.habitstracker.profile.domain.SyncRepository
