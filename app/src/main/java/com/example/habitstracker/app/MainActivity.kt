...
import com.example.habitstracker.core.data.worker.ReminderWorker
import com.example.habitstracker.core.presentation.theme.AppTheme
import com.example.habitstracker.core.presentation.utils.RequestNotificationPermission
import com.example.habitstracker.core.presentation.utils.calculateInitialDelay
...
// Розраховуємо час до найближчого нагадування (ваша функція calculateInitialDelay)
...
// Використовуємо REPLACE, щоб якщо користувач перезайде в додаток, таймер оновився
